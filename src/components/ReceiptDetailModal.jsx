  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
      <motion.div
        ...
        className="relative w-full max-w-xl bg-dark-bg border border-dark-border rounded-3xl p-6 sm:p-8 shadow-2xl overflow-hidden max-h-[90vh] flex flex-col justify-between"
      >
        {/* Header */}
        <div className="flex items-center justify-between border-b border-dark-border pb-4 mb-4">
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg text-gray-400 hover:text-white hover:bg-dark-card"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="overflow-y-auto pr-1 space-y-6 flex-1">
          ...
          {/* Time & Location Pill */}
          <div className="p-4 rounded-2xl bg-dark-card border border-dark-border space-y-2 font-mono text-xs text-gray-300">
