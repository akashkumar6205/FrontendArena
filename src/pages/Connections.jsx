    ...
    <div className="space-y-8 pb-16">
      ...
      <div className="border-b border-dark-border pb-6">
        ...
        <p className="text-xs text-gray-400 mt-1 max-w-2xl">
          Visualizing hidden relationships across time, geography, music listening, transactions, and digital notes.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {connections.slice(0, 8).map((conn, idx) => (
            <div
              ...
              className="p-5 rounded-2xl bg-dark-card border border-dark-border hover:border-emerald-500/50 cursor-pointer transition-all hover:-translate-y-0.5 shadow-xl space-y-3 group"
            >
